...
export class Jumper extends BaseEnemy 
{
...
// export class Jumper extends Phaser.Physics.Arcade.Sprite 
// {
//    /**
...
//    * @param {string} _texture       - key/spriteTag del spritesheet/atlas (por defecto 'jumper')
//    */
//     constructor(_scene,_posX,_posY,_texture='jumper')
//     { //instanciar el objeto
//         super(_scene,_posX,_posY,_texture);
